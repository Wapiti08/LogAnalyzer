...
class LogParser:
    ...
    def outputResult(self, logClustL):
        ...
        # if self.keep_para:
        if log_templates:
            # element in ParameterList is list type
    ...
    def parse(self, logName):
        ...
        for idx, line in self.df_log.iterrows():
            ...
            if count % 1000 == 0 or count == len(self.df_log):
                print('Processed {0:.1f}% of log lines.'.format(int(count) * 100.0 / len(self.df_log)))
    ...
    def entropy(self, string):
        ''' Used to encrypt the parameter in ParameterList
    ...
    def get_parameter_list(self, row):
        ...
        template_regex = r"^" + template_regex.replace(r"\<\*\>", "(.*?)") + "$"
