...
# struct_log_com = '../../Dataset_ML/Linux_mal_matrix/mal_matrix.npy'
...
if __name__ == '__main__':
    ...
    parser = optparse.OptionParser("usage %prog --p1 <train matrix> --p2 <test matrix>")

    parser.add_option('--p1', dest='struct_log', type='string', help='Please input the path of training matrix:')
    parser.add_option('--p2', dest='struct_log_com', type='string', help='Please input the path of coming matrix:')

    (options, args) = parser.parse_args()

    struct_log = options.struct_log
    print(struct_log)
    struct_log_com = options.struct_log_com
    ...
    (x_test, _), (_, _) = dataloader.load_Linux(struct_log_com, window = 'sliding', split_type = 'sequential')
    ...
    sliding_file_path = '../../Dataset_ML/Linux/Clear/_sliding_24h_3h.csv'
